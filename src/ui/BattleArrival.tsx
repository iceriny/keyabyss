...
export function BattleArrival({ book, reduced, reveal, complete, sound }: {
  ...
  return <div className={`battle-arrival${reduced ? " reduced" : ""}`} style={{ "--arrival-color": book.color } as CSSProperties} aria-hidden="true">
    <div className="arrival-veil" />
    <div className="arrival-gate"><Sigil progress={1} /></div>
    <div className="arrival-wave" />
    <div className="arrival-book"><BookArtwork book={book} decorative /></div>
